...
void UKUIPanelLayout::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        UKUIPanelLayout *_t = static_cast<UKUIPanelLayout *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (UKUIPanelLayout::*_t)(Plugin * );
...
const QMetaObject UKUIPanelLayout::staticMetaObject = {
    { &QLayout::staticMetaObject, qt_meta_stringdata_UKUIPanelLayout.data,
      qt_meta_data_UKUIPanelLayout,  qt_static_metacall, nullptr, nullptr}
};
