...
void AddPluginDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AddPluginDialog *_t = static_cast<AddPluginDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (AddPluginDialog::*_t)(const LXQt::PluginInfo & );
...
const QMetaObject AddPluginDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AddPluginDialog.data,
      qt_meta_data_AddPluginDialog,  qt_static_metacall, nullptr, nullptr}
};
