...
void ConfigPluginsWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ConfigPluginsWidget *_t = static_cast<ConfigPluginsWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (ConfigPluginsWidget::*_t)();
...
const QMetaObject ConfigPluginsWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ConfigPluginsWidget.data,
      qt_meta_data_ConfigPluginsWidget,  qt_static_metacall, nullptr, nullptr}
};
