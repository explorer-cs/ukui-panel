...
void ShowDesktop::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ShowDesktop *_t = static_cast<ShowDesktop *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ShowDesktop::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ShowDesktop.data,
      qt_meta_data_ShowDesktop,  qt_static_metacall, nullptr, nullptr}
};
...
const QMetaObject ShowDesktopLibrary::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ShowDesktopLibrary.data,
      qt_meta_data_ShowDesktopLibrary,  qt_static_metacall, nullptr, nullptr}
};
...
void *ShowDesktopLibrary::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "lxde-qt.org/Panel/PluginInterface/3.0"))
        return static_cast< IUKUIPanelPluginLibrary*>(this);
    return QObject::qt_metacast(_clname);
}
