...
void StartMenu::init_mainwindow()
{
 ...
 * 显示全屏窗口
 */
void StartMenu::show_fullscreen_widget(int arg)
{
//    this->showMaximized();
 ...
 * 显示默认窗口
 */
void StartMenu::show_default_widget(int arg)
{
//    this->showNormal();
 ...
 * 鼠标点击窗口外部事件
 */
bool StartMenu::event ( QEvent * event )
{
